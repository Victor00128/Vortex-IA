...
const Header: React.FC<HeaderProps> = ({ currentPersonality, onPersonalityChange, isLoading }) => {
  return (
    <header className="bg-zinc-900/70 backdrop-blur-sm p-3 md:p-4 border-b border-zinc-700 shadow-lg sticky top-0 z-10">
      <div className="max-w-4xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-6 h-6 md:w-8 md:h-8 text-red-500 mr-2 md:mr-3 drop-shadow-[0_0_5px_rgba(239,68,68,0.5)]"
          >
            <path
          ...
          <h1 className="text-lg md:text-xl font-bold text-black hidden sm:block">AI Chat Pro</h1>
        </div>
        <div className="relative">
          <select
            ...
            disabled={isLoading}
            className="appearance-none bg-zinc-800 border border-zinc-700 rounded-md py-2 pl-3 pr-8 text-black text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px] md:min-w-[150px]"
